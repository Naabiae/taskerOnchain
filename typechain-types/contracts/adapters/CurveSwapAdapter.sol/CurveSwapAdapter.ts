...
export interface CurveSwapAdapterInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "canExecute"
      | "execute"
...
export interface CurveSwapAdapter extends BaseContract {
  connect(runner?: ContractRunner | null): CurveSwapAdapter;
  waitForDeployment(): Promise<this>;

  interface: CurveSwapAdapterInterface;
