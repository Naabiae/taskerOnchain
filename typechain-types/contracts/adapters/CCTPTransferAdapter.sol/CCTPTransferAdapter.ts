...
export interface CCTPTransferAdapterInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "canExecute"
      | "execute"
...
export interface CCTPTransferAdapter extends BaseContract {
  connect(runner?: ContractRunner | null): CCTPTransferAdapter;
  waitForDeployment(): Promise<this>;

  interface: CCTPTransferAdapterInterface;
