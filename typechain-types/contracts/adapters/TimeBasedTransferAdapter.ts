...
export interface TimeBasedTransferAdapter extends BaseContract {
  connect(runner?: ContractRunner | null): TimeBasedTransferAdapter;
  waitForDeployment(): Promise<this>;

  interface: TimeBasedTransferAdapterInterface;
