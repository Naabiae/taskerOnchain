...
export interface CompoundStrategyAdapterInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "canExecute"
      | "execute"
...
export interface CompoundStrategyAdapter extends BaseContract {
  connect(runner?: ContractRunner | null): CompoundStrategyAdapter;
  waitForDeployment(): Promise<this>;

  interface: CompoundStrategyAdapterInterface;
