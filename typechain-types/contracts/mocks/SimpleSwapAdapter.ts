...
export interface SimpleSwapAdapterInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "canExecute"
      | "execute"
  ...
  getEvent(
    nameOrSignatureOrTopic: "ActionExecuted" | "SwapExecuted"
  ): EventFragment;
...
export interface SimpleSwapAdapter extends BaseContract {
  connect(runner?: ContractRunner | null): SimpleSwapAdapter;
  waitForDeployment(): Promise<this>;

  interface: SimpleSwapAdapterInterface;
