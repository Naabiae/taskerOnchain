...
export interface MockStrategyAdapterInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "canExecute"
      | "canExecuteReason"
  ...
  encodeFunctionData(
    functionFragment: "canExecuteResult",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface MockStrategyAdapter extends BaseContract {
  connect(runner?: ContractRunner | null): MockStrategyAdapter;
  waitForDeployment(): Promise<this>;

  interface: MockStrategyAdapterInterface;
  ...
  canExecuteReason: TypedContractMethod<[], [string], "view">;

  canExecuteResult: TypedContractMethod<[], [boolean], "view">;
  ...
  setCanExecute: TypedContractMethod<
  ...
  >;
  getFunction(
    nameOrSignature: "canExecuteReason"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
    nameOrSignature: "canExecuteResult"
